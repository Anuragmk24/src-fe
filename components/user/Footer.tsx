...
function Footer() {
    return (
        <><div id='footer' className="relative">
            {/* Background image */}
            <img className="w-full h-60 sm:h-auto object-cover" src="/assets/images/footerImg.jpg" alt="Footer Background" />
                    ...
                    <div className="flex flex-col  items-start md:items-center text-center text-white space-y-0 sm:space-y-4">
                        ...
                        <div className="grid  grid-cols-3 gap-6 text-sm sm:text-base">
                            ...
                            <div className="space-y-2">
                                <h2 className="font-bold underline text-[10px]">Registration</h2>
                                <div className="flex items-center gap-x-2 text-[10px] sm:text-sm">
                                    {/* <FaPhoneAlt size={35} className="text-yellow-400 text-[10px] " /> */}
                                    Ar. Amit Kamal: +91 9511771463
                                </div>
                            </div>

                            {/* Hospitality Section */}
                            <div className="space-y-2">
                                <h2 className="font-bold underline text-[10px] sm:text-sm">Hospitality</h2>
                                <div className="flex items-center gap-x-2 text-[10px] sm:text-sm">
                                    {/* <FaPhoneAlt size={35} className="text-yellow-400 text-[10px]" /> */}
                                    Ar. Shyam: +91 9895404502
                                </div>
                            </div>

                            {/* General Section */}
                            <div className="space-y-2">
                                <h2 className="font-bold underline text-[10px] sm:text-sm">General</h2>
                                <div className="flex items-center gap-x-2 text-[10px] sm:text-sm">
                                    {/* <FaPhoneAlt className="text-yellow-400" /> */}
                                    Ar. Lookman: +91 9048614309
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        </div><div className="py-8 bg-[#38AE88] font-medium text-center text-white">
