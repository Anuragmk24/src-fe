...
function PriceDetails({ fee, price }: { fee: any, price: any }) {
    ...
    return (
        <div className="border rounded-t-xl md:w-1/3 g-white dark:bg-gray-900 text-black dark:text-white ">
            ...
            <div className="border-t bg-gray-100 flex justify-between px-4 py-2 font-bold g-white dark:bg-gray-900 text-black dark:text-white">
                <h2>Total</h2>
                <h2 className="flex items-center">
                    <MdCurrencyRupee />
                    {totalPrice}
