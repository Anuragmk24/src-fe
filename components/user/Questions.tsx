    ...
    return (
        <div className="bg-white  mb-6 g-white dark:bg-white text-black dark:text-black">
            ...
            {question === 'Do you want accomodation' && (
                <Points
                    points="Room sharing arrangements will be based on the type of booking and group size. For group bookings, rooms are more likely to be allocated according to the number of participants: groups of two will receive double occupancy(1 king-sized bed
) rooms (with couples receiving first preference), groups of three will be placed in triple occupancy(1 king-sized bed and one queen sized bed
) rooms, and groups of four in quadruple occupancy(2 king-sized beds) rooms.
