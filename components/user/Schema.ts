...
export const registrationSchemaForStudents = z
    .object({
        definition: z
            .string()
            .optional()
    ...
    .superRefine((data, ctx) => {
        ...
        // if (data.isStudentAffiliatedToIia) {
        //     data.group?.forEach((member, index) => {
        //         if (!member.iia) {
        //             ctx.addIssue({
        //                 code: 'custom',
        //                 message: 'IIA number is required for students affiliated with IIA',
        //                 path: ['group', index, 'iia'],
        //             });
        //         }
        //     });
        // }
    });
export const registrationSchemaForStudentsWithIia = z
    .object({
        definition: z
            .string()
            .optional()
        ...
        group: z
            .array(
                z.object({
                    ...
                    iia: z
                        .string()
                        .nonempty('Iia number is required')
