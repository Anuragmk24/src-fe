...
function SubmitButton({ uniqueUsers, amount }: { uniqueUsers: any; amount: any }) {
    ...
    const onSubmit = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                return_url: `${process.env.NEXT_PUBLIC_BACKEND_URL}/v1/accomodation/response`,
            ...
            if (result.hash) {
                ...
                const inputs = [
                    ...
                    { name: 'return_url', value: `${process.env.NEXT_PUBLIC_BACKEND_URL}/v1/accomodation/response` },
    ...
    return (
        <button type="button" onClick={onSubmit} className="bg-[#E5E52E] my-3 font-mono text-[#16616E] font-bold px-4 py-2 rounded-md hover:bg-[#E5E52E]" disabled={loading}>
