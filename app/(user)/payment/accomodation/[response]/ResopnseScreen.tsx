                ...
                {data?.paymentStatus === 'SUCCESS' ? (
                    <>
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-md text-gray-700">Save this reference id</p>
                        </div>
                        ...
                        {/* Action Button */}
                        <a href="/add-accomodation" className="inline-block px-6 py-3 mt-4 text-lg font-semibold text-white bg-green-500 rounded-full hover:bg-green-600 transition duration-300">
                            Add Accomodation
                        </a>
                    </>
                    ...
                    <>
                        ...
                        <a href="/add-accomodation" className="inline-block px-6 py-3 mt-4 text-lg font-semibold text-white bg-red-500 rounded-full hover:bg-red-600 transition duration-300">
                            Try Again
                        </a>
                    </>
                ) : (
                    <>
                        ...
                        <div className="flex justify-center">
                            <a href="/add-accomodation" className="px-8 py-3 text-lg font-medium text-white bg-yellow-500 rounded-full shadow hover:bg-yellow-600 transition duration-300 ease-in-out">
                                Try Again
                            </a>
                        </div>
                    </>
